...
part_type_size(particle1,0.40,0.40,0,0);
part_type_scale(particle1,1.08,1.34);
part_type_color3(particle1,4608599,10160608,7220788);
...
part_type_life(particle1,60,73);
...
part_type_size(particle2,0.39,0.89,0,0);
part_type_scale(particle2,2.19,1);
part_type_color3(particle2,862015,10815443,9816929);
...
part_type_life(particle2,80,10);
...
part_type_size(particle3,0.50,0.90,0,0);
part_type_scale(particle3,1.54,1);
part_type_color3(particle3,16744703,65535,4227327);
...
part_type_life(particle3,66,103);
